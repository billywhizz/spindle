...
class Loop {
  ...
  poll (timeout = -1) {
    const { fd, maxEvents, events, callbacks } = this
...
Loop.prototype.Readable = EPOLLIN
Loop.prototype.Writable = EPOLLOUT | EPOLLET
Loop.prototype.ReadableWritable = EPOLLIN | EPOLLOUT
