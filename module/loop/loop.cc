{"epoll_create1":{"parameters":["i32"],"result":"i32","name":"create"},"epoll_ctl":{"parameters":["i32","i32","i32","pointer"],"pointers":[null,null,null,"struct epoll_event *"],"result":"i32","name":"modify"},"epoll_wait":{"parameters":["i32","pointer","i32","i32"],"pointers":[null,"struct epoll_event *"],"result":"i32","name":"wait"},"close":{"parameters":["i32"],"result":"i32","name":"close"}}
