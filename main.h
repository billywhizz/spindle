...
void register_builtins() {
  ...
  spin::builtins_add("system.js", _binary_lib_system_js_start, _binary_lib_system_js_end - _binary_lib_system_js_start);
...
static const char* v8flags = "--stack-trace-limit=10 --use-strict --turbo-fast-api-calls --single-threaded --nolazy";
